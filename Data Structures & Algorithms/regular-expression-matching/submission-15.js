class Solution {
    ...
    matchHelper(s, p, currS = 0, currP = 0, visited = {}){
        ...
        if(currP < p.length-1 && p[currP+1] === '*'){
            if(match){
                visited[currS + '#' + currP] = true && this.matchHelper(s, p, currS+1, currP, visited) || this.matchHelper(s,p, currS, currP+2, visited);
            } else{
                visited[currS + '#' + currP] = true && this.matchHelper(s, p, currS, currP+2, visited);
            }
        } else if(match){
            visited[currS + '#' + currP] = true && this.matchHelper(s, p, currS+1, currP+1, visited);
        } else{
